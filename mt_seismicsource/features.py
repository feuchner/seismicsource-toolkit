...
# focal mechanism
AREA_SOURCE_ATTR_FM_SS = {'name': 'fm_ss', 'type': QVariant.Int}
AREA_SOURCE_ATTR_FM_NF = {'name': 'fm_nf', 'type': QVariant.Int}
AREA_SOURCE_ATTR_FM_TF = {'name': 'fm_tf', 'type': QVariant.Int}
