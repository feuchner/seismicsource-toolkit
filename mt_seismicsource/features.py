...
# focal mechanism
AREA_SOURCE_ATTR_FM_SS = {'name': 'SS', 'type': QVariant.Int}
AREA_SOURCE_ATTR_FM_NF = {'name': 'NF', 'type': QVariant.Int}
AREA_SOURCE_ATTR_FM_TF = {'name': 'TF', 'type': QVariant.Int}

AREA_SOURCE_ATTRIBUTES_FOCALMECH = (AREA_SOURCE_ATTR_FM_SS, 
    AREA_SOURCE_ATTR_FM_NF, AREA_SOURCE_ATTR_FM_TF)
...
AREA_SOURCE_ATTRIBUTES_ALL.extend(AREA_SOURCE_ATTRIBUTES_FOCALMECH)
...
FAULT_SOURCE_ATTR_EQ_CNT_FBZ = {'name': 'eq_count_fbz', 'type': QVariant.Int}
FAULT_SOURCE_ATTR_AREA_FBZ = {'name': 'area_fbz_sqkm', 'type': QVariant.Double}
FAULT_SOURCE_ATTR_EQ_CNT_BZ = {'name': 'eq_count_bz', 'type': QVariant.Int}
FAULT_SOURCE_ATTR_AREA_BZ = {'name': 'area_bz_sqkm', 'type': QVariant.Double}
FAULT_SOURCE_ATTR_AREA_FAULT = {'name': 'area_fault_sqkm', 'type': QVariant.Double}

FAULT_SOURCE_ATTRIBUTES_RECURRENCE = (
    FAULT_SOURCE_ATTR_ID,
    FAULT_SOURCE_ATTR_NAME,
    ...
    FAULT_SOURCE_ATTR_EQ_CNT_FBZ,
    FAULT_SOURCE_ATTR_AREA_FBZ,
    FAULT_SOURCE_ATTR_EQ_CNT_BZ,
    FAULT_SOURCE_ATTR_AREA_BZ,
    FAULT_SOURCE_ATTR_AREA_FAULT)
